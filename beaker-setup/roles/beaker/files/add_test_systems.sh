...
systems="
    beaker-test-vm1;beaker-in-a-box_beaker-test-vm1;
    beaker-test-vm2;beaker-in-a-box_beaker-test-vm2;
    beaker-test-vm3;beaker-in-a-box_beaker-test-vm3;
"
tmpdir=$(mktemp -d)
...
for system in $systems; do
   ...
   echo "power,$name,qemu+ssh:192.168.120.1,$power_id,virsh" >>$tmpdir/02-power.csv
done
